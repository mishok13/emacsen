...
(custom-theme-set-faces
 ...
 '(mode-line ((((class color) (min-colors 89)) (:box (:line-width -1 :style released-button) :background "grey20" :foreground "grey80"))))
 '(mode-line-inactive ((((class color) (min-colors 89)) (:box (:line-width -1 :style released-button) :background "grey30" :foreground "ivory"))))
 ...
 '(flymake-errline ((t (:background "#704040"))))
 '(flymake-warnline ((t (:background "#7080a0"))))
 '(hl-line ((t (:background "gray50" :inherit highlight)))))

(provide-theme 'mishok-dark)
