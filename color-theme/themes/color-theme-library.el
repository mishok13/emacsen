 ...
 (color-theme-install
  '(color-theme-mishok
    ...
    ((buffers-tab-face . buffers-tab)
     ...
     (cperl-pod-head-face . font-lock-variable-name-face)
     (vc-mode-face . highlight))
    (default ((t (:background "grey60" :foreground "black"))))
    (blue ((t (:foreground "blue"))))
    (bold ((t (:bold t))))
    (bold-italic ((t (:bold t))))
    (border-glyph ((t (nil))))
    ...
    (message-mml-face ((t (:bold t :foreground "Green3"))))
    (message-separator-face ((t (:foreground "blue3"))))
    (modeline ((t (:background "gray45" :foreground "black" :box (:line-width 1 :style released-button)))))
    (modeline-buffer-id ((t (:background "gray45" :foreground "black"))))
    (modeline-mousable ((t (:background "gray45" :foreground "black"))))
    (modeline-mousable-minor-mode ((t (:background "gray45" :foreground "black"))))
    (pointer ((t (nil))))
    (primary-selection ((t (:background "grey45"))))
    (red ((t (:foreground "red"))))
